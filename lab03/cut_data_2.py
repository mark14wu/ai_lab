import pandas as pd
train_data = pd.read_csv("tap_fun_train.csv")
dir_name = 'train'
'''
def show_num(data):
...
show_num(train_data)
'''
new_train_set = train_data[(train_data.pay_price > 0) & (train_data.avg_online_minutes >15 )]
...
temp2 = new_train_set[(new_train_set.pay_more_price > 0)].sample(frac=1)
temp2['payment'] = 1
print(len(temp2))
